...
{/block}
{block name="content"}
	{form name="admin/banner/edit" state="readonly" enctype="multipart/form-data"}
	...
	{/foreach}
		<div id="uploadContent">
			...
			标题：<div id=div1><input id=file1 type=text size=50 name="title[]" value="{$value}"></div>
		</div>
	...
	<script type="text/javascript">
		...
		function addUpload() {
			...
			var newDiv = "<div id=divUpload" + count + ">"
					...
					+ "</div>"
					+ "</br>"
					+ " 标题：<input id=title" + count + " type=text size=50 name=title[]>"
